...
if (sizeof($datos) > 0) {
    $output = ["accion" => "obtener_cantidad_ventas_maquinaria", "data" => $datos, "consulta" => $query, "correcto" => true];
} else {
    $output = ["accion" => "obtener_cantidad_ventas_maquinaria", "data" => $datos, "consulta" => $query, "correcto" => false];
}
